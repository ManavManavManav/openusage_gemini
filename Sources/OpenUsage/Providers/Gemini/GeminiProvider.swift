...
@MainActor final class GeminiProvider: ProviderRuntime {
 ...
 var widgetDescriptors: [WidgetDescriptor] { [.percent(id: "gemini.session", provider: provider, title: "Session", metricLabel: "Session"), .percent(id: "gemini.weekly", provider: provider, title: "Weekly", metricLabel: "Weekly"), .usageTrend(provider: provider)] }

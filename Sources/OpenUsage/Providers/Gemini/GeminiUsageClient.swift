...
enum GeminiUsageError: LocalizedError, CategorizedError, Equatable {
    case missingLogin, expired, unavailable, unsupportedAuthMode
    var errorDescription: String? { switch self { case .missingLogin: "Sign in to Gemini CLI with Google to view Code Assist usage."; case .expired: "Gemini Google login has expired. Sign in again in Gemini CLI."; case .unavailable: "Gemini usage is temporarily unavailable."; case .unsupportedAuthMode: "Gemini API-key and Vertex AI modes do not expose personal Code Assist limits." } }
    var errorCategory: ErrorCategory { switch self { case .missingLogin: .notLoggedIn; case .expired: .authExpired; case .unsupportedAuthMode: .notAvailable; case .unavailable: .network } }
}
